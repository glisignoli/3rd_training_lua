...
print("  project url (trials): https://github.com/glisignoli/3rd_training_lua/tree/test")
print("-----------------------------")
print("WIP")
...
--- FBNeo runs on_start function as soon as the lua script is loaded
function on_start()
  load_trial()
end

--- FBNeo runs before_frame function every frame
